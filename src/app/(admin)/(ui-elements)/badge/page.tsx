...
export const metadata: Metadata = {
  title: "Next.js Badge | Консультант Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Консультант Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
};
