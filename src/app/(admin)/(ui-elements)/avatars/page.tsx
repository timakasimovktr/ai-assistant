...
export const metadata: Metadata = {
  title: "Next.js Avatars | Консультант Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Консультант Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
};
