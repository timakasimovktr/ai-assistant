...
export const metadata: Metadata = {
  title: "Next.js Modals | Консультант Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Консультант Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
