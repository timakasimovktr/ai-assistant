...
export const metadata: Metadata = {
  title: "Next.js Buttons | Консультант Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Консультант Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
};
